...
const (
	GroupName = "pico.rasberrypi.com"
	Version   = "v1alpha1"

	GpuConfigKind      = "GpuConfig"
	FirmwareConfigKind = "FirmwareConfig"
)
...
type FirmwareConfig struct {
	...
	FirmwareName    FirmwareName `json:"firmware,omitempty"`
}
...
func DefaultFirmwareConfig() *FirmwareConfig {
	return &FirmwareConfig{
		TypeMeta: metav1.TypeMeta{
			...
			Kind:       FirmwareConfigKind,
		},
		FirmwareName: "MicroPython",
	}
}
...
func (c *FirmwareConfig) Normalize() error {
	if c == nil {
		return fmt.Errorf("config is 'nil'")
	}
	if c.FirmwareName == "" {
		c.FirmwareName = "MicroPython"
	}
	return nil
}
