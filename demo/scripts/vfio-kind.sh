...
: "${UPSTREAM_HOST_SETUP_HINT:=https://github.com/kubevirt/kubevirt/tree/main/kubevirtci/cluster-up/cluster/vfio-gpu}"
...
verify_vfio_setup() {
    ...
    if [[ ${#devs[@]} -eq 0 ]]; then
        ...
        echo "by kubevirt's kubevirtci vfio-gpu provider:"
        echo ""
