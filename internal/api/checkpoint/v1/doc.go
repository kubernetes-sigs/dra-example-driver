...
//
// In practice, this is likely to be the only supported version because
// introducing a new version would be difficult. See the checkpoint package
// documentation for more information on versioning.
package v1
